 ...
 * @author FAM
 */
public class PinjamKasirView extends javax.swing.JFrame {
    ...
    DefaultTableModel tableModel = new DefaultTableModel(
            new Object[][]{}, new String[]{"ID Buku", "Judul Buku", "Harga Pinjam"}) {
    ...
    /**
     * Creates new form PinjamKasirView
     */
    public PinjamKasirView() {
        ...
        initComponents();
        setTitle("Peminjaman Buku - Faraz Information System (FISt)");
    ...
    public JDateChooser getInputTanggal_kembali() {
    ...
    private void initComponents() {
        ...
        buttonInsertPinjam = new faraz.view.usu.Button();
        labelDenda1 = new javax.swing.JLabel();
        ...
        labelFokusId_membernbuku = new javax.swing.JLabel();
        inputTanggal_kembali = new com.toedter.calendar.JDateChooser();
        buttonBack = new faraz.view.usu.Button();
        ...
        buttonInsertPinjam.setIcon(new javax.swing.ImageIcon(getClass().getResource("/faraz/view/images/simpan.png"))); // NOI18N
        buttonInsertPinjam.setText("Simpan");
        buttonInsertPinjam.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        buttonInsertPinjam.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                buttonInsertPinjamActionPerformed(evt);
            }
        });

        labelDenda1.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        labelDenda1.setForeground(new java.awt.Color(255, 255, 255));
        labelDenda1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        labelDenda1.setText("Tgl Kembali :");
        ...
        jLabel2.setText("<html>\nPenting!!<br/>\nJangan lupa masukkan tanggal pengembalian<br/>\nuntuk seluruh buku, lalu tekan tombol simpan<br/>\nuntuk menyimpan transaksi.");
        ...
        labelFokusId_membernbuku.setFont(new java.awt.Font("Segoe UI", 2, 14)); // NOI18N
        labelFokusId_membernbuku.setForeground(new java.awt.Color(255, 255, 255));
        labelFokusId_membernbuku.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);

        inputTanggal_kembali.setDateFormatString("dd MMMM yyyy");
        inputTanggal_kembali.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        inputTanggal_kembali.setMaxSelectableDate(new java.util.Date(253370743274000L));

        buttonBack.setIcon(new javax.swing.ImageIcon(getClass().getResource("/faraz/view/images/kembali.png"))); // NOI18N
                    ...
                    .addGroup(panelMain1Layout.createSequentialGroup()
                        .addGroup(panelMain1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(panelMain1Layout.createSequentialGroup()
                                .addGroup(panelMain1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(panelMain1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        ...
                                        .addGroup(panelMain1Layout.createSequentialGroup()
                                            .addComponent(labelDenda1)
                                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                            .addComponent(inputTanggal_kembali, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                                    .addComponent(labelFokusId_membernbuku, javax.swing.GroupLayout.PREFERRED_SIZE, 244, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelMain1Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)))
                        .addGroup(panelMain1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 484, Short.MAX_VALUE)
                            .addGroup(panelMain1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(buttonInsertPinjam, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                    .addGroup(panelMain1Layout.createSequentialGroup()
                        .addGap(0, 0, Short.MAX_VALUE)
                        .addComponent(labelDenda2)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(labelTotal, javax.swing.GroupLayout.PREFERRED_SIZE, 133, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
                ...
                .addGroup(panelMain1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panelMain1Layout.createSequentialGroup()
                        ...
                        .addGroup(panelMain1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                            .addComponent(buttonInsertPinjam, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(panelMain1Layout.createSequentialGroup()
                        .addComponent(labelFokusId_membernbuku, javax.swing.GroupLayout.PREFERRED_SIZE, 72, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(panelMain1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void buttonResetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonResetActionPerformed
        ...
        inputTanggal_kembali.setDateFormatString("");
    ...
    private void buttonInsertPinjamActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonInsertPinjamActionPerformed
        // TODO add your handling code here:
        if(pinjamController.insertPinjamKasir(this) == true) {
            bukuController.updatePinjamBukuKasir(this);
            JOptionPane.showMessageDialog(this, "Transaksi Peminjaman berhasil disimpan");
        }
        else {
            JOptionPane.showMessageDialog(this, "Transaksi Peminjaman gagal");
        }
        
    }//GEN-LAST:event_buttonInsertPinjamActionPerformed
    ...
    private void inputId_memberFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_inputId_memberFocusGained
        // TODO add your handling code here:
        labelFokusId_membernbuku.setText("<html>Masukkan ID Member yang ingin meminjam buku, pastikan member memperlihatkan kartu membernya</html>");
    ...
    private void inputId_bukuFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_inputId_bukuFocusGained
        // TODO add your handling code here:
        labelFokusId_membernbuku.setText("<html>Masukkan ID Buku yang tertera pada buku, pastikan buku yang dipinjam benar</html>");
    ...
    private faraz.view.usu.Button buttonBack;
    private faraz.view.usu.Button buttonBatal;
    private faraz.view.usu.Button buttonHapus;
    private faraz.view.usu.Button buttonInsertPinjam;
    ...
    private com.toedter.calendar.JDateChooser inputTanggal_kembali;
    private javax.swing.JLabel jLabel1;
    private javax.swing.JLabel jLabel2;
    private javax.swing.JScrollPane jScrollPane;
    private javax.swing.JLabel labelDenda1;
    private javax.swing.JLabel labelDenda2;
    private javax.swing.JLabel labelFokusId_membernbuku;
